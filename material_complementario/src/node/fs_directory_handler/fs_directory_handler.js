...
fs.mkdir(path.join(__dirname, 'directorio1'), (error) => {
    if (error) {
...
fs.rename(path.join(__dirname, 'directorio1'), path.join(__dirname, 'directorio2'), (error) => {
    if (error) {
...
fs.rmdir(path.join(__dirname, 'directorio1'), (error) => {
    if (error) {
